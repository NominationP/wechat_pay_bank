...
class Rsa
{
    ...
    public function __construct($private_key_filepath="private_key.pem", $public_key_filepath="public_f.pem") {
    ...
    public function publicEncrypt($data = '') {        
        ...
        return openssl_public_encrypt($data, $encrypted, $this->_getPublicKey(),OPENSSL_PKCS1_OAEP_PADDING) ? base64_encode($encrypted) : null;
    }
